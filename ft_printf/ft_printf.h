...
/*   Updated: 2021/09/19 15:13:45 by esafar           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	flagzero(int nb, t_var var, int lower);
int	flagminus2(int nb, t_var var, int lower);
...
int	monpoint(int nb, t_data flags, int count);
...
// static int	adjust(char *str, t_data flags);
